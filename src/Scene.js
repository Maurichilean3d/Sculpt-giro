...
class Scene {
  ...
  start() {
    ...
    // init orientation widget once DOM is available
  ...
  initGrid() {
    ...
    // Place the grid slightly below the origin along the canonical UP axis
    if (isZUp()) mat4.translate(gridm, gridm, [0.0, 0.0, -0.45]);
    else mat4.translate(gridm, gridm, [0.0, -0.45, 0.0]);
    var scale = 2.5;
  ...
  applyRender() {
    ...
    // 2D orientation widget (top-right)
